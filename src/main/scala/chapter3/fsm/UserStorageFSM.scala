...
import chapter3.fsm.UserStorageFSM.{Connect, DBOperation, Disconnect, Operation}
...
object FiniteStateMachine extends App {
  ...
  userStorage ! Operation(DBOperation.Create, UserStorageFSM.User("Admin", "admin@packt.com"))
